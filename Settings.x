...
- (void)updateYTLiteSectionWithEntry:(id)entry {
    ...
    YTSettingsSectionItem *support = [%c(YTSettingsSectionItem) itemWithTitle:LOC(@"SupportDevelopment") accessibilityIdentifier:@"YTLiteSectionItem" detailTextBlock:^NSString *() { return @"♡"; } selectBlock:^BOOL (YTSettingsCell *cell, NSUInteger arg1) {
        ...
        [sheetController addAction:[%c(YTActionSheetAction) actionWithTitle:@"MB Bank: 600659" iconImage:[self resizedImageNamed:@"github"] secondaryIconImage:nil accessibilityIdentifier:nil handler:^ {
            [%c(YTUIUtils) openURL:[NSURL URLWithString:@"https://github.com/sponsors/vinkay215"]];
        }]];
    ...
    selectBlock:^BOOL (YTSettingsCell *cell, NSUInteger arg1) {
        NSArray <YTSettingsSectionItem *> *rows = @[
            [self linkWithTitle:@"Vinkay" description:LOC(@"Developer") link:@"https://github.com/vinkay215/"],
            ...
            [self linkWithTitle:@"Vinkay" description:LOC(@"Vietnamese") link:@"https://github.com/vinkay215"]
        ];
